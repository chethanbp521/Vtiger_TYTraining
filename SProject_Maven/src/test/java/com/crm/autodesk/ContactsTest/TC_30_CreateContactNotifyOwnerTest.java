...
public class TC_30_CreateContactNotifyOwnerTest extends BaseClass
{
	@Test (groups = "SmokeSuite")
	public void createContactNotifyOwner() throws Throwable
	{
		...
		createContPg.clickNotifyOwnerChkBox();
